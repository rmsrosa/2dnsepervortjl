...
````
Test.DefaultTestSet("check composition `irfft ∘ rfft`", Any[], 1, false, false)
````
...
````
Test.DefaultTestSet("Check operators", Any[], 5, false, false)
````
...
````
Test.DefaultTestSet("Check single-mode stable steady state", Any[], 5, false, false)
````
